  ...
  return (
    <div class='cartFoodpar'>
      <div class='cartFoodchil1'>
        ...
        <p className='cartFoodchil5'><b>Wines & More</b> (Kacyiru, Rwanda)</p>
        ...
        <div className='cartFoodchil22'>
          <p className='cartFoodchil20'>Red Wine Bottle</p>
          <p className='cartFoodchil21'>25,000Rwf</p>
        </div>
        <hr className='cartFoodchil13'></hr>
        <div className='cartFoodchil14'>
          <img src='../cartPic3.png' className='cartFoodchil17'></img>
        ...
        <div className='cartFoodchil22'>
          ...
          <p className='cartFoodchil21'>0Rwf</p>
        </div>
        <div className='cartFoodchil22'>
          <p className='cartFoodchil20'>Total</p>
          <p className='cartFoodchil21'>26,000Rwf</p>
        </div>
        <hr className='cartFoodchil13'></hr>
