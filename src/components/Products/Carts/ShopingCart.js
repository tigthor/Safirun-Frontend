  ...
  return (
    <div class='cartFoodpar'>
      <div class='cartFoodchil1'>
        ...
        <p className='cartFoodchil5'><b>Kigali Electronics</b> (Kacyiru, Rwanda)</p>
        ...
        <div className='cartFoodchil22'>
          <p className='cartFoodchil20'>Flash Drives</p>
          <p className='cartFoodchil21'>5,000Rwf</p>
        </div>
        <hr className='cartFoodchil13'></hr>
        <div className='cartFoodchil14'>
          <img src='../cartPic3.png' className='cartFoodchil17'></img>
        ...
        <div className='cartFoodchil22'>
          ...
          <p className='cartFoodchil21'>6,500Rwf</p>
        </div>
        <hr className='cartFoodchil13'></hr>
